...
export const lobbyStore = reactive({
  ...
  // Note: All AI Takes Over discipline methods have been extracted to separate stores:
  // - bildertitelStore.js
  // - dreiWortChaosStore.js
  // - autocompleteChaosStore.js
  // - conspiracyCornerStore.js
  // - werbungFuerMuellStore.js
  // - duellStore.js
})
