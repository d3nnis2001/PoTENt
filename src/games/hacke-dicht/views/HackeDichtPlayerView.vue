...
// Components
import PlayerJoinForm from '../components/mobile/PlayerJoinForm.vue'
import PlayerWaitingScreen from '../components/mobile/PlayerWaitingScreen.vue'
import PlayerGamePhase from '../components/mobile/PlayerGamePhase.vue'

// Dynamic import of character images
const importCharacterImages = () => {
  const images = []
  const modules = import.meta.glob('@/assets/games/hacke-dicht/characters/Character*.png', { eager: true })
