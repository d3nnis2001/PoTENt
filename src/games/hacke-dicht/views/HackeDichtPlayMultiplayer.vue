...
import LoadingView from '../components/game/LoadingView.vue'
import GameNotFoundView from '../components/game/GameNotFoundView.vue'
import ProgressScreen from '../components/game/ProgressScreen.vue'
import EventQuestionView from '../components/game/EventQuestionView.vue'
import LeaderboardView from '../components/game/LeaderboardView.vue'
import JokerMessageModal from '../components/game/JokerMessageModal.vue'
import AudioControls from '@/shared/components/AudioControls.vue'
import JokersPanel from '../components/game/JokersPanel.vue'

// Multiplayer Komponenten
import QuestionCard from '../components/multiplayer/QuestionCard.vue'
import QuestionHeader from '../components/multiplayer/QuestionHeader.vue'
import AnswerFeedback from '../components/multiplayer/AnswerFeedback.vue'
import LobbySetupForm from '../components/multiplayer/LobbySetupForm.vue'
import LobbyWaitingArea from '../components/multiplayer/LobbyWaitingArea.vue'
import TeaserModal from '../components/multiplayer/TeaserModal.vue'
